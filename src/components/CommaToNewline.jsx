...
export default function CommaToNewline() {
    ...
    <div className="flex flex-col h-full">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
          <List className="w-6 h-6 text-[#5F7C87]" />
          Comma to Newline
        </h2>
        <p className="text-gray-400">Replace commas with line breaks in your text</p>
      </div>

      <div className="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden">
        {/* Input Section */}
        <div className="flex-1 lg:w-1/2 flex flex-col min-h-0">
          <label className="text-sm font-semibold text-[#5F7C87] mb-2">Input Text</label>
          <textarea
            value={input}
        ...
        {/* Output Section */}
        <div className="flex-1 lg:w-1/2 flex flex-col min-h-0">
          <label className="text-sm font-semibold text-[#5F7C87] mb-2">Output (Comma → Newline)</label>
