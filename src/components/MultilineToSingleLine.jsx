    ...
    <div className="flex flex-col h-full">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
          <AlignJustify className="w-6 h-6 text-[#5F7C87]" />
          Multiline to Single Line
        </h2>
        <p className="text-gray-400">Collapse pasted multiline text into one line</p>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden">
        ...
        {/* Output Section */}
        <div className="flex-1 lg:w-1/2 flex flex-col min-h-0">
          <label className="text-sm font-semibold text-[#5F7C87] mb-2">Output (Single Line)</label>
